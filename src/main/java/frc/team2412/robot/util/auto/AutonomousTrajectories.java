...
public class AutonomousTrajectories {
	private static final Subsystems s = new Subsystems();
	...
	public static final SetWristCommand wristIn = new SetWristCommand(s.armSubsystem, s.intakeSubsystem, WRIST_RETRACT);
	public static final SequentialCommandGroup score = new SequentialCommandGroup(wristOut, intakeOut, wristIn);
