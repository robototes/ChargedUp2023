...
public class PhysicsSim {
	/**
	 * Returns a random number between min and max with values near min and max
	 * having a higher
	 * probability.
	 *
	 * @param min
	...
	/**
	 * Returns a random number between 0 and max with values near 0 or max having a
	 * higher probability.
	 *
	 * @param max
	 *            The maximum value produced.
	 ...
	 * @param stallTorque
	 *            The stall torque of the motor connected to SparkMAX (units
	 *            are N m).
	 * @param freeSpeed
