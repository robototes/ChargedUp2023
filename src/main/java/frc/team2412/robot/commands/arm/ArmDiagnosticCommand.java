...
public class ArmDiagnosticCommand extends SequentialCommandGroup {
	public ArmDiagnosticCommand(ArmSubsystem armSubsystem, IntakeSubsystem intakeSubsystem) {
		addCommands(
				...
				new WaitCommand(0.5),
				new SetFullArmCommand(armSubsystem, ARM_LOW_POSITION),
				new WaitCommand(0.5),
				new SetWristCommand(armSubsystem, WRIST_SCORE),
				new WaitCommand(0.5),
				new SetWristCommand(armSubsystem, WRIST_RETRACT),
				new WaitCommand(0.5),
				new SetFullArmCommand(armSubsystem, ARM_MIDDLE_POSITION),
				new WaitCommand(0.5),
				new SetWristCommand(armSubsystem, WRIST_SCORE),
				new WaitCommand(0.5),
				new SetWristCommand(armSubsystem, WRIST_RETRACT),
				new WaitCommand(0.5),
				new SetFullArmCommand(armSubsystem, ARM_SUBSTATION_POSITION),
				new WaitCommand(0.5),
				new SetWristCommand(armSubsystem, WRIST_SCORE),
				new WaitCommand(0.5),
				new SetWristCommand(armSubsystem, WRIST_RETRACT),
				new WaitCommand(0.5),
				new SetFullArmCommand(armSubsystem, ARM_HIGH_POSITION),
				new WaitCommand(0.5),
				new SetWristCommand(armSubsystem, WRIST_SCORE));
	}
}
